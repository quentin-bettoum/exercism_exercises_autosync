...
def convert_coordinate(coordinate: AzaraCoordinate) -> tuple[str, str]:
...
def compare_records(azara_record: AzaraRecord, rui_record: RuiRecord) -> bool:
    ...
    _, (coord_a, coord_b), _ = rui_record
    _, azara_coordinates = azara_record

    return azara_coordinates == coord_a + coord_b


def create_record(azara_record: AzaraRecord, rui_record: RuiRecord) -> tuple | str:
