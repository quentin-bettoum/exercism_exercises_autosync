...
type Treasure = str
type AzaraCoordinate = str
type AzaraRecord = tuple[Treasure, AzaraCoordinate]

type Location = str
type Quadrant = str
type RuiCoordinate = tuple[str, str]
type RuiRecord = tuple[Location, RuiCoordinate, Quadrant]

type CombinedRecord = tuple[
    Treasure, AzaraCoordinate, Location, RuiCoordinate, Quadrant
]
